...
public:
    ...
    virtual void noteWhichVariablesWeMightWantOptimisticBoundsFor(vector<unsigned int> & toUpdate)
    {
    }
...
public:
    ...
    static void noteWhichVariablesWeMightWantOptimisticBoundsFor(vector<unsigned int> & toUpdate);
