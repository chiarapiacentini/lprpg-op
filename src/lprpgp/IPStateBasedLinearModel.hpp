...
#ifndef IPStateBasedLinearModel_hpp
#define IPStateBasedLinearModel_hpp
...
class IPStateBasedLinearModel : public IPStateBasedModel {
public:
    IPStateBasedLinearModel(MinimalState & state, int horizon, vector<bool> & aL, vector<bool> & fL, vector<bool> & aE, vector<bool> & fE, bool d = false) :  IPStateBasedModel(state,horizon, aL, fL, aE, fE, d), delta(1), infinity(10),  minMaxValues(0), minMaxSteps(0){
        infinity = 100000;//
        //infinity = IloInfinity;
        
    }
    
    ~IPStateBasedLinearModel(){
...
#endif /* IPStateBasedLinearModel_hpp */
