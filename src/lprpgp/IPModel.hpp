...
class IPModel{
public:
    IPModel(bool d = false) : maxT(RPGBuilder::getNOp()),pL(0), h(-1), debug(d), addWarmStart(false), iBool(0), iBoolAux(0), iInt(0), iCount(0) { initialised = true; isTimeLimit = false; checkOptimal = false;}
