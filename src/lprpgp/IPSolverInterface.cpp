 ...
 *
 ************************************************************************/
#include "IPSolverInterface.hpp"

void IPSolverInterface::initialise(){
    solver->initialise();
}


void IPSolverInterface::start(MinimalState & state){
    if (initialised){
        initialise();
        initialiseVariables();
        buildConstraints();
...
// solve
bool IPSolverInterface::solve(){
   
    return false;
}

void IPSolverInterface::setLPRelaxation(bool b){
