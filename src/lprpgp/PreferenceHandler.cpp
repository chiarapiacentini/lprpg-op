...
namespace PrefCommon {
    ...
    void noteVariablesForFactAtSomePoint(vector<unsigned int> & toUpdate, const int & prefIdx,RPGBuilder::Preference * const pref, bool inGoal=true)
    {    
...
void SometimeFSA::noteWhichVariablesWeMightWantOptimisticBoundsFor(vector<unsigned int> & toUpdate)
{
...
void AtMostOnceFSA::noteWhichVariablesWeMightWantOptimisticBoundsFor(vector<unsigned int> & toUpdate)
{
...
void SometimeAfterFSA::noteWhichVariablesWeMightWantOptimisticBoundsFor(vector<unsigned int> & toUpdate)
{
    PrefCommon::noteVariablesForFactAtSomePoint(toUpdate, prefIdx, pref);
}
...
void SometimeBeforeFSA::noteWhichVariablesWeMightWantOptimisticBoundsFor(vector<unsigned int> & toUpdate)
{
...
void PreconditionPref::noteWhichVariablesWeMightWantOptimisticBoundsFor(vector<unsigned int> & toUpdate)
{
...
void PreferenceHandler::noteWhichVariablesWeMightWantOptimisticBoundsFor(vector<unsigned int> & toUpdate)
{
    const int pCount = automata.size();
